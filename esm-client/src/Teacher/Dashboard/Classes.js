...
function Classes(props) {
   ...
   if (classesList)
      classesList = classesList.length > trimLength ? classesList.slice(-trimLength).reverse() : classesList;
   ...
   return (
      <>
         <div className="left__header red__header">
            <p className="left__header__text">{<HiOutlineClipboardList />}Các khối phân công</p>
         </div>
