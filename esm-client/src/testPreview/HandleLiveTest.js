               ...
               <div className="left__side">
                  <div className="test__info">
                     ...
                     <div className="test__name">
                        Bài kiểm tra môn: <span className="danger">{this.props.testName}</span>
                     </div>
                  ...
                  <div className="questions__status">
                     <div className="total__answered box">
                        <span className="count__answered">{this.state.totalAnswered} </span>
                        Câu đã làm
                     </div>
                     ...
                     <div className="total__pending box">
                        <span className="count__pending">{this.state.totalPending} </span>
                        Câu chưa làm
                     </div>
                  </div>
                  <LeftSide
